					...
					<div class="col-sm-6">
						<div class="your-order">
							...
							<div class="your-order-body" style="padding: 0px 10px">
								...
								<div class="your-order-item">
									<div class="pull-left"><p class="your-order-f18">Tổng tiền:@if(Session::has('cart')){{number_format($totalPrice)}}@else 0 @endif</p></div>
									<div class="pull-right"><h5 class="color-black">đồng
									</h5></div>
									@if(Session::has('cart'))
									{{number_format($totalPrice)}} @else 0 @endif
									<div class="clearfix"></div>
								</div>
							</div>
